<?php
$page_title = 'বইয়ের ক্যাটাগরি | সব ধরনের সাহিত্যের সমাহার - অন্ত্যমিল';
$page_description = 'গল্প, উপন্যাস থেকে শুরু করে বিজ্ঞান ও প্রযুক্তি—সব ধরনের বইয়ের সমাহার। অন্ত্যমিল ক্যাটাগরি পেজে আপনার প্রিয় বিষয়ের বইগুলো সহজে খুঁজে নিন।';
$page_keywords = 'বইয়ের ক্যাটাগরি, সাহিত্য, ফিকশন, নন-ফিকশন, অন্ত্যমিল, VIVAGO TECHNOLOGIES, Book Categories, অনলাইন লাইব্রেরি';
$path_prefix = '../';
