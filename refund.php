    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 leading-relaxed text-gray-700 space-y-6">
            ...
            <div class="space-y-6 text-gray-700 font-light">
                ...
                <p><strong class="font-medium text-brand-900">4. Refund Process:</strong> Once your returned item is received and inspected by Ontomeel, eligible refunds will be approved and processed to the original payment method used for the purchase. Refund processing times may vary depending on your bank, card issuer, or payment service provider and typically take 7-10 working days to be completed. Please note that shipping and delivery charges are generally non-refundable unless the return is required due to an error on the part of Ontomeel, such as the shipment of a defective, damaged, or incorrect item.</p>
            ...
            <div class="space-y-6 text-gray-700 font-light">
                ...
                <div>
                    ...
                    <ul class="list-disc pl-5 mt-2 space-y-1">
                        ...
                        <li>ব্যাংক, মোবাইল ফাইন্যান্সিয়াল সার্ভিস বা পেমেন্ট সেবাদাতার প্রক্রিয়ার ওপর নির্ভর করে রিফান্ড সম্পন্ন হতে সাধারণত <strong>৭–১০ কর্মদিবস</strong> সময় লাগতে পারে।</li>
                    </ul>
