...
<body
    class="antialiased selection:bg-brand-gold selection:text-white bg-brand-900 min-h-screen flex items-center justify-center relative overflow-hidden py-10 md:py-20">
    ...
    <div class="max-w-xl w-full px-4 sm:px-6 relative z-10">
        <!-- Logo -->
        <div class="flex flex-col items-center mb-8 md:mb-12 reveal">
            ...
            <p class="text-brand-gold text-[9px] sm:text-[10px] font-bold uppercase tracking-[0.4em] mt-2">অ্যাডমিন এনরোলমেন্ট</p>
        </div>

        <!-- Signup Card -->
        <div class="glass-dark p-6 sm:p-8 md:p-12 rounded-[30px] sm:rounded-[40px] border border-white/10 shadow-2xl reveal"
            ...
            <form action="process_admin_signup.php" method="POST" class="space-y-4 sm:space-y-6">
                <div class="space-y-1">
                    <label class="text-[9px] sm:text-[10px] font-bold text-gray-500 uppercase tracking-widest font-anek ml-2">সম্পূর্ণ
                        নাম</label>
                    <input type="text" name="full_name" required placeholder="Ex: Admin User"
                        class="w-full bg-white/5 border border-white/10 rounded-2xl px-5 sm:px-6 py-3.5 sm:py-4 focus:outline-none focus:ring-2 focus:ring-brand-gold focus:bg-white/10 transition-all font-anek text-white text-sm sm:text-base">
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <div class="space-y-1">
                        <label
                            class="text-[9px] sm:text-[10px] font-bold text-gray-500 uppercase tracking-widest font-anek ml-2">ইউজারনেম</label>
                        <input type="text" name="username" required placeholder="admin_one"
                            class="w-full bg-white/5 border border-white/10 rounded-2xl px-5 sm:px-6 py-3.5 sm:py-4 focus:outline-none focus:ring-2 focus:ring-brand-gold focus:bg-white/10 transition-all font-anek text-white text-sm sm:text-base">
                    </div>
                    <div class="space-y-1">
                        <label class="text-[9px] sm:text-[10px] font-bold text-gray-500 uppercase tracking-widest font-anek ml-2">পদবী
                            (Role)</label>
                        <select name="role"
                ...
                <div class="space-y-1">
                    <label class="text-[9px] sm:text-[10px] font-bold text-gray-500 uppercase tracking-widest font-anek ml-2">অফিসিয়াল
                        ইমেইল</label>
                ...
                <div class="space-y-1">
                    <label
                        class="text-[9px] sm:text-[10px] font-bold text-gray-500 uppercase tracking-widest font-anek ml-2">পাসওয়ার্ড</label>
                ...
                <div class="pt-6 text-center border-t border-white/10 mt-6 font-anek">
                    <p class="text-gray-500 text-xs sm:text-sm">ইতিমধ্যে অ্যাকাউন্ট আছে? <a href="../login/"
                            class="text-brand-gold font-bold hover:underline">লগইন করুন</a></p>
                </div>
            </form>
        </div>

        <p class="text-center text-gray-500 text-[9px] sm:text-[10px] mt-8 md:mt-10 uppercase tracking-widest font-anek">সুরক্ষিত এলাকা:
