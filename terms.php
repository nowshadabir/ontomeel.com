    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 leading-relaxed text-gray-700 space-y-6">
            ...
            <div class="space-y-6 text-gray-700 font-light">
                <p><strong class="font-medium text-brand-900">1. General:</strong> These Terms & Conditions govern your use of the Ontomeel website and the purchase of products offered through our online bookstore. We reserve the right to update, modify, or replace these terms at any time. Any changes will be effective immediately upon posting on this page.</p>
            ...
            <div class="space-y-6 text-gray-700 font-light">
                <div>
                    ...
                    <p>এই শর্তাবলী অন্ত্যমিলের ওয়েবসাইট, ডিজিটাল সেবা এবং আমাদের মাধ্যমে পরিচালিত সকল পণ্য ক্রয়ের ক্ষেত্রে প্রযোজ্য।</p>
